...
if not ClickBinder or ClickBinder.version<VERSION then
	...
	function ClickBinder.CreateFrames()
		...
		press:SetText(CRYOLYSIS_BINDING.Press)
		...
		cancel:SetText(CRYOLYSIS_BINDING.Cancel)
		...
		unbind:SetText(CRYOLYSIS_BINDING.Unbind)
	...
	function ClickBinder.StartBinding()
		...
		ClickBinderCurrent:SetText(CRYOLYSIS_BINDING.Now..(GetBindingKey(ClickBinderBindFrame.action) or CRYOLYSIS_BINDING.NotBound))
	end
	...
	function ClickBinder.SetKeyBinding()
		if not InCombatLockdown() then
			...
			CRYOLYSIS_Msg(CRYOLYSIS_BINDING.InCombat);
		end
